...
public class UserController {
    ...
    // =================================================================
    // 🎯 ၁။ Admin panel - List all users with their ban status
    // URL: GET /user/list
    // =================================================================
    @GetMapping("/list")
    ...
    // =================================================================
    // 🎯 ၂။ Admin action - Update user details
    // URL: POST /user/save
    // =================================================================
    @PostMapping("/save")
    ...
    // =================================================================
    // 🎯 ၃။ Admin action - Delete user (GET)
    ...
    // =================================================================
    // 🎯 ၄။ Admin action - Delete user (POST)
    // URL: POST /user/admin/delete
    // =================================================================
    @PostMapping("/admin/delete")
    public String deleteUserPost(@RequestParam("userId") Integer userId, HttpSession session) {
        User loginUser = (User) session.getAttribute("loginUser");
        if (loginUser == null || !"admin".equals(loginUser.getRole())) {
            return "redirect:/login";
        }
    ...
    // =================================================================
    // 🎯 ၅။ Admin action - Suspend/Unsuspend user (AJAX)
    // URL: POST /user/toggle-suspend/{id}
    // =================================================================
    ...
    // =================================================================
    // 🎯 ၇။ Follow or unfollow a user (AJAX)
    ...
    // =================================================================
    // 🎯 ၈။ Get follow status for a user (AJAX)
    // URL: GET /user/follow/status/{userId}
    // =================================================================
    ...
    // =================================================================
    // 🎯 ၉။ Get followers list for a user
    // URL: GET /user/followers/{userId}
    // =================================================================
    ...
    // =================================================================
    // 🎯 ၁၀။ Get following list for a user
    // URL: GET /user/following/{userId}
    // =================================================================
    ...
    // =================================================================
    // 🎯 ၁၁။ Search users (AJAX endpoint for admin)
    // URL: GET /user/search
    // =================================================================
    @GetMapping("/search")
    @ResponseBody
