        ...
        <div class="profile-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-auto text-center text-md-start">
                    <c:choose>
                        <c:when test="${not empty profileUser.profileImg && profileUser.profileImg ne 'default-avatar.png'}">
                            <img src="${pageContext.request.contextPath}/uploads/${profileUser.profileImg}"
                ...
                <div class="col-md-auto text-center text-md-end mt-3 mt-md-0">
                    <div class="d-flex flex-wrap gap-2 justify-content-center justify-content-md-end">
                        <!-- Back to Profile button (from second version) -->
                        <a href="${pageContext.request.contextPath}/profile/view" class="btn btn-back-profile">
                            <i class="fa-regular fa-arrow-left me-1"></i> Back to Profile
                        </a>
                        
                        <c:choose>
                            <c:when test="${sessionScope.loginUser.userId == profileUser.userId}">
                                <a href="${pageContext.request.contextPath}/profile/view" class="btn btn-primary-custom">
                            ...
                            <c:otherwise>
                                <button
                                    ...
                                    <i class="fa-regular ${isFollowing ? 'fa-user-check' : 'fa-user-plus'} me-1"></i>
            ...
            <c:forEach items="${userSheets}" var="sheet">
                <div class="col-md-6 col-lg-4">
                    <div class="sheet-card">
                        <!-- 🎯 FIXED: Image path with proper escaping -->
                        <c:choose>
                            <c:when test="${not empty sheet.fileUrl}">
                                <img src="${pageContext.request.contextPath}${sheet.fileUrl}"
                                    ...
                                    onerror="this.onerror=null; this.parentElement.innerHTML='<div class=\"image-placeholder\"><i class=\"fa-regular fa-image\"></i><span>No Image</span></div>';" />
                            </c:when>
                            <c:otherwise>
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex gap-2">
                                <a href="${pageContext.request.contextPath}/cheatsheets/view/${sheet.id}"
                                    class="btn btn-outline-custom flex-grow-1 text-center">
                                    <i class="fa-regular fa-eye me-1"></i> View
                                </a>
                                <button onclick="copyToClipboard('${fn:escapeXml(sheet.content)}', '${fn:escapeXml(sheet.title)}')"
                                    class="btn btn-outline-custom flex-grow-1 text-center">
