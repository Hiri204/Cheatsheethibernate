...
<style>
    ...
    /* ===== Input Group for Password with Eye Toggle ===== */
...
<body>
    ...
    <div class="login-card">
        ...
        <p class="text-center subtitle">Sign in to access your cheat sheets</p>
        ...
        <div class="text-center small" style="color: #6c757d;">
            ...
            <a href="${pageContext.request.contextPath}/register"
                class="register-link">
                <i class="fa-solid fa-user-plus me-1"></i>Register for free
            </a>
        </div>
    </div>
            ...
            <div class="modal-content modal-content-custom">
                ...
                <div class="modal-body modal-body-custom">
                    ...
                    <div class="ban-reason-box">
                        <span class="label">
                            <i class="fa-regular fa-clock me-1"></i> Ban Duration
                        </span>
                        <span class="ban-duration-badge">
                            ${not empty banDuration ? banDuration : 'Permanent'}
                        </span>
                    </div>

                    <div class="ban-reason-box mt-3">
                        <span class="label">
                            <i class="fa-solid fa-gavel me-1"></i> Reason for Suspension
                        </span>
                        <div class="reason-text">
                            ${not empty banReason ? banReason : 'No specific reason provided. Please contact support for more information.'}
                        </div>
                    </div>
    ...
    <script>
        ...
        /**
         * Handle banned user modal and form disable
         */
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (isBanned === "true") {
                ...
                if (modalElement) {
                    ...
                    if (loginForm) {
                        var inputs = loginForm.querySelectorAll('input, button');
                        inputs.forEach(function(input) {
                            input.disabled = true;
                        });
                    }

                    // Focus on "I Understand" button when modal is shown
                    modalElement.addEventListener('shown.bs.modal', function() {
                        document.getElementById('understandBtn').focus();
                    });

                    // When modal is hidden, redirect to refresh the page
            ...
            if (loginForm && signInBtn) {
                loginForm.addEventListener('submit', function() {
                    ...
                    signInBtn.innerHTML = '<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>Signing In...';
                });
            }
        });
    </script>
